...
var test = new BFG.Leaderboard({
	...
	dataCallback:function(){
		return [//simulates incoming data
			{id:1,title:"The Johnsons",count:BFG.rnd(1,20)},
			{id:2,title:"Our House",count:BFG.rnd(1,30)},
			{id:3,title:"IamGreen",count:BFG.rnd(1,30)},
			{id:4,title:"Solar Slurpie",count:BFG.rnd(1,10)},
			{id:5,title:"Tyrion Lannister",count:BFG.rnd(1,10)},
			{id:6,title:"The Agarwals",count:BFG.rnd(1,20)},
			{id:7,title:"Daenerys Targaryen",count:BFG.rnd(1,20)},
			{id:8,title:"Samwell Tarly",count:BFG.rnd(1,30)},
			{id:9,title:"The Amirs",count:BFG.rnd(1,20)},
			{id:10,title:"Cersei Lannister",count:BFG.rnd(1,20)},
			{id:11,title:"Catelyn Stark",count:BFG.rnd(1,20)},
			{id:12,title:"Ygritte",count:BFG.rnd(1,30)},
			{id:13,title:"Jaime Lannister",count:BFG.rnd(1,30)},
			{id:14,title:"Bran Stark",count:BFG.rnd(1,10)},
			{id:15,title:"Varys",count:BFG.rnd(1,10)}
		];
	}
});
test.start();
